...
*/
const XPTN = 'RIzkyBot'; // JANGAN DI UBAH NNTI EROR
...
conn.sendMessage(id, 'itu pembuat Rizky bot' ,MessageType.text);
}
else if (text == 'Sagiri'){
...
conn.sendMessage(id, 'jangan toxic cu' ,MessageType.text);
}
else if (text == 'ngentod'){
conn.sendMessage(id, 'jangan toxic cu' ,MessageType.text);
}
...
conn.sendMessage(id, 'apa woi' ,MessageType.text);
}
else if (text == 'woi'){
conn.sendMessage(id, 'apa woi' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'ada apa eoy' ,MessageType.text);
}
else if (text == 'eoy'){
conn.sendMessage(id, 'ada apa eoy' ,MessageType.text);
}
else if (text == 'Hi'){
conn.sendMessage(id, 'hi juga beb' ,MessageType.text);
}
else if (text == 'hi'){
conn.sendMessage(id, 'hi juga beb' ,MessageType.text);
}
else if (text == 'Gan'){
conn.sendMessage(id, 'ada apa nih gan' ,MessageType.text);
}
else if (text == 'gan'){
conn.sendMessage(id, 'ada apa nih gan' ,MessageType.text);
}
else if (text == 'Sis'){
conn.sendMessage(id, 'semongko' ,MessageType.text);
}
else if (text == 'sis'){
conn.sendMessage(id, 'semongko' ,MessageType.text);
}
else if (text == 'Bro'){
conn.sendMessage(id, 'ada apa nih bro' ,MessageType.text);
}
else if (text == 'bro'){
conn.sendMessage(id, 'ada apa nih bro' ,MessageType.text);
}
else if (text == 'Min'){
conn.sendMessage(id, 'ya ada apa??' ,MessageType.text);
}
else if (text == 'min'){
conn.sendMessage(id, 'ya ada apa??' ,MessageType.text);
}
else if (text == 'Sayang'){
conn.sendMessage(id, 'ada apa sayang' ,MessageType.text);
}
else if (text == 'sayang'){
conn.sendMessage(id, 'ada apa sayang' ,MessageType.text);
}
...
conn.sendMessage(id, 'lop yu to' ,MessageType.text);
}
else if (text == 'Mas'){
conn.sendMessage(id, 'ya ada apa mas' ,MessageType.text);
}
else if (text == 'mas'){
conn.sendMessage(id, 'ya ada apa mas' ,MessageType.text);
}
else if (text == 'Mba'){
conn.sendMessage(id, 'ya ada apa mba' ,MessageType.text);
}
else if (text == 'mba'){
conn.sendMessage(id, 'ya ada apa mba' ,MessageType.text);
}
else if (text == 'Bre'){
conn.sendMessage(id, 'yo kenapa bre' ,MessageType.text);
}
else if (text == 'bre'){
conn.sendMessage(id, 'yo kenapa bre' ,MessageType.text);
}
else if (text == 'Cuy'){
conn.sendMessage(id, 'uy ada apa' ,MessageType.text);
}
else if (text == 'cuy'){
conn.sendMessage(id, 'uy ada apa' ,MessageType.text);
}
else if (text == 'hallo'){
conn.sendMessage(id, 'hallo juga' ,MessageType.text);
}
else if (text == '.hai'){
conn.sendMessage(id, 'Hai juga' ,MessageType.text);
}
else if (text == '.grup'){
conn.sendMessage(id, 'https://chat.whatsapp.com/LLCSpSL2S8A1NJwTnMIgWY' ,MessageType.text);
}
else if (text == '.menu1'){
...
conn.sendMessage(id, 'apa euy' ,MessageType.text);
}
else if (text == '.help'){
conn.sendMessage(id, 'jika kalian ingin script bot ini kalian bisa ketik .owner / .creator' ,MessageType.text);
}
else if (text == 'makasi'){
...
conn.sendMessage(id, '*MATA KAU STREES*' ,MessageType.text);
}
else if (text == 'Rizky'){
conn.sendMessage(id, 'apa sayangku' ,MessageType.text);
}
// Fitur
...
conn.sendMessage(id, "https://chat.whatsapp.com/LLCSpSL2S8A1NJwTnMIgWY" + code , MessageType.text, { quoted: m })
...
conn.sendMessage(id, ' terimakasih sudah menggunakan bot RIZKY BOT jangan lupa follow ig mimin ya @_rizkyfadilah8' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' terimakasih sudah menggunakan bot RIZKY BOT jangan lupa follow ig mimin ya @_rizkyfadilah8' ,MessageType.text);
}
...
if (text.includes(".lirik")){
	...
	axios.get(`http://scrap.terhambar.com/lirik?word=${teks}`).then ((res) => {
	     conn.sendMessage(id, '[WAIT]Sedang Mencari Lirik Yang Anda cari🔎', MessageType.text)
...
if (text.includes('.ssweb')){
  ...
  var teks = text.replace(/.waifu /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.image, {caption: "🔍Foto Telah di temukan\n\nBerhasil💯", quoted: m })
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT]Sedang Mencari Foto Yang Anda cari🔎', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
...
if (text.includes('Rizky')) {
 ...
 const options = {
       text: `ehhhh.... apaan tu ada nama owner ku @${nomor.split("@s.whatsapp.net")[0]}, aku kupingin ahh ><`,
